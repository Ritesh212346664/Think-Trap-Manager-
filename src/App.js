...
function PageConnect({ connected, setConnected, channelInfo, setChannelInfo }) {
  ...
  const [claudeKey, setClaudeKey] = useState(() => localStorage.getItem("tt_claudekey") || "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");
...
export default function App() {
  ...
  const [channelInfo, setChannelInfo] = useState(() => {
    ...
    return {
      ...
      apiKey: localStorage.getItem("tt_apikey") || "AIzaSyA9wDyx5MJKoqfgcqEolJyuuMalHHHDypo",
      channelId: localStorage.getItem("tt_channelid") || "UCtnTosDIBsRWTUMrmXsEYj",
      oauthId: localStorage.getItem("tt_oauthid") || "",
      claudeKey: localStorage.getItem("tt_claudekey") || "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",
    };
  });
